...
public class PowerConversion {
  ...
  public void beforeMethod() throws IOException {
	  ...
	  try {
	  FileInputStream input = new FileInputStream("C:\\Users\\chndn\\eclipse-workspace6\\Officail_Project222\\src\\test\\resources\\Properties\\PowerConversionData.properties");
	  prop.load(input);
